...
exports.seed = async function(knex, Promise) {
  ...
  const sourceMeta = [
        {id: '80fe6e1e-6f1b-4b3c-957c-275d12bb3e48', msgCount: 6000},
        {id: 'f7516443-c498-4493-9acc-c854ca2e873a', msgCount: 300},
        {id: '4e7cb748-9d37-4705-9d16-bd68a80afc39', msgCount: 10000},
        {id: 'f4f96516-c5ec-43bb-ba21-da1f35dacf8a', msgCount: 100},
        {id: '914d66ba-4368-450a-870b-d8fcd7fd34d6', msgCount: 1000},
  ];

  const dummyMsgs = [];
  const statusStates = ['error', 'enqueued', 'processing', 'finished']
